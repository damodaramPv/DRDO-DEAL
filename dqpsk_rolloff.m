...
dataBits = randi([0,1], numSymbols*2, 1);
...
% Design RRC filter
rrcFilter = rcosdesign(rf, span, samplesPerSymbol);
...
figure(1)
plot(rolloff, bw);
title('Bandwidth vs rolloff');
xlabel('Rolloff factor'); ylabel('Bandwidth of trasmitted signal');
